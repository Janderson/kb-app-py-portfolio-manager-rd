import pandas as pd
import unittest
from core.cdataframe import COHLCDataFrame, CDataFramesJoined
...
class TestCoreCDataFrame(unittest.TestCase):
            ...
            [
                {
                    ...
                    "close": 3,
                    "volume": 15000,
                    "time": pd.to_datetime("2020-05-18"),
                    "ticker": "TICKERA",
                    "timeframe": "M15",
                },
                {
                    ...
                    "close": 3,
                    "volume": 15000,
                    "time": pd.to_datetime("2020-05-19"),
                    "ticker": "TICKERA",
                    "timeframe": "M15",
                },
                {
                    ...
                    "close": 14,
                    "volume": 14,
                    "time": pd.to_datetime("2020-05-14"),
                    "ticker": "TICKERA",
                    "timeframe": "M15",
                },
            ]
    ...
    def test_cdatafame_should_be_valid(self):
        ...
        self.assertTrue(
            list(cdataframe.dataframe.columns)
    ...
    def test_cdatafame_with_data_inside_should_be_valid(self):
        ...
        self.assertEqual(
            cdataframe.dataframe.iloc[0].time, pd.to_datetime("2020-05-14")
        )
...
class TestCDataFramesJoined(unittest.TestCase):
        ...
        dfA = pd.DataFrame(
            [
                ...
                },
                {
                    ...
                    "close": 2,
                    "volume": 15000,
                    "time": pd.to_datetime("2020-05-15"),
                    "ticker": "TICKERA",
                    "timeframe": "M15",
                },
                {
                    ...
                    "close": 3,
                    "volume": 15000,
                    "time": pd.to_datetime("2020-05-16"),
                    "ticker": "TICKERA",
                    "timeframe": "M15",
                },
            ]
    ...
    def test_unit_join(self):
        ...
        self.assertEqual(cdfs_joined.tickers, ["TICKERA", "TICKERB"])

        expected_df_shape = cdfs_joined.join().shape
        observed_df_shape = (3, 2)
        self.assertEqual(expected_df_shape, observed_df_shape)
